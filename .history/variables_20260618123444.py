...
def tellArguments(**kwargs):
   for key, value in kwargs.items():
       print(key + ": " + value)
a = tellArguments(arg1 = "argument 1", arg2 = "argument 2", arg3 = "argument 3")
print(a)
...
obj = InterviewbitEmployee("Sonam")
...
print(re.match(['[A-Za-z0-9]+$','abdc1321']))
print(re.match(["A-Za-z0-9]+$','xyz@123$"]))